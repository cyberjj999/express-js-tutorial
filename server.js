...
// This is the static file rendering example (around lines ~119)
// Used to render static file, takes in express.static method which takes in the name of the folder we placed our static files in - which is 'public' in this case
// If we navigate to localhost:3000/ - we will see the content of index.html
// If we navigate to localhost:3000/test/examplePage.html, we will see examplePage.html content
app.use(express.static("public"));

// To parse Form/JSON data - you need this portion to  access the req.body data from your /users/ POST endpoint in users.js
// This syntax is just boilerplate, i.e. it is what it is; no much logic
...
/* Serving Static HTML File - Middleware Example */
...
// See the app.use(express.static()) code above for more comments
